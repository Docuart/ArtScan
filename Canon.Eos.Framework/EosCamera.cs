...
namespace Canon.Eos.Framework
{
    public sealed partial class EosCamera : EosObject
    {
        ...
        internal EosCamera(IntPtr camera) : base(camera)
        {
            Util.Assert(Edsdk.EdsGetDeviceInfo(this.Handle, out _deviceInfo),  "Failed to get device info.");                  
        ...
        public new string Artist
        {
            ...
            set { this.SetPropertyStringData(Edsdk.PropID_Artist, value, MaximumArtistLengthInBytes); }
        }
        ...
        private void OnError(Exception exception)
        {
            if (!this.IsErrorTolerantMode)
                throw exception;
            //this.OnError(new EventArgs { Exception = exception });
        }

        private void OnError(EventArgs args)
        {
            if (this.Error != null)
        ...
        public void TakePicture()
        {
            ...
            Util.Assert(this.SendCommand(Edsdk.CameraCommand_TakePicture), "Failed to take picture.");                                 
        }
